      ...
      <div className="flex-1 p-6">
        <div className="max-w-[560px] mx-auto space-y-6">
          ...
          <form onSubmit={handleSubmit} className="panel p-5 space-y-4">
            ...
            <div>
              <label className="eyebrow block mb-2">API Secret</label>
              <input
                type="password"
                value={apiSecret}
            ...
            {success && (
              <div className="flex items-start gap-2 text-sm text-[var(--long)] font-mono border border-[var(--long-dim)] bg-[var(--long-dim)]/10 px-3 py-2">
