...
import { ArrowLeft, Loader2, Users, PlayCircle } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        disabled={busy || (!follower.exchangeConnected && !follower.copyTradingEnabled)}
        title={
          !follower.exchangeConnected && !follower.copyTradingEnabled
            ? "Follower must connect a verified exchange key first"
            : undefined
        }
                  ...
                  <tbody className="font-mono">
                    {followers.map((f) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 tabular">{fmtUsd(f.lastKnownBalanceUSDT)}</td>
                        <td className="px-4 py-3">
                          <StatusPill
